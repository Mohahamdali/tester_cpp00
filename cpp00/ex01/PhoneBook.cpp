...
void PhoneBook::add_contact(const std::string &fullname,
                     ...
                     const std::string &last_name)
{
    ...
    contacts[index].set_fullname_and_number(fullname, number, nickname, secret_field, last_name);
    contact_count++;
}

void PhoneBook::search_contact()
{
    int total = contact_count < 8 ? contact_count : 8;
